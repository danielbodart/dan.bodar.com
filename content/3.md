...
<strong>What we have built already:</strong>

<strong>RESTful Web Site and Web Components </strong>
...
<strong>Post/Redirect/Get pattern</strong><a href="http://en.wikipedia.org/wiki/Post/Redirect/Get" target="blank">
http://en.wikipedia.org/wiki/Post/Redirect/Get</a>
...
<strong>Simple transaction boundaries </strong>
...
<strong>Extended SiteMesh
</strong><a href="http://www.opensymphony.com/sitemesh/" title="http://www.opensymphony.com/sitemesh/">http://www.opensymphony.com/sitemesh/</a>
...
<strong>AHAH (Asynchronous HTML and HTTP)<a href="http://microformats.org/wiki/rest/ahah" target="blank">
</a></strong><a href="http://microformats.org/wiki/rest/ahah" target="blank"> http://microformats.org/wiki/rest/ahah</a><strong><a href="http://microformats.org/wiki/rest/ahah" target="blank"> </a></strong>

This enables much simpler JavaScript to be written (think JavaScript that never needs to replicate the domain model or business rules on the client) and allows for complete reuse of server side logic. This combined with behaviour CSS bindings ( <a href="http://www.bennolan.com/behaviour/" target="blank">http://www.bennolan.com/behaviour/ </a>) leads to NO in-line JavaScript nastiness and more semantic html.

<strong>No Session State just persistent documents </strong>
...
<strong>In memory web acceptance testing </strong>
...
<strong>Progressive Enhancement and Accessibility
</strong><a href="http://en.wikipedia.org/wiki/Progressive_Enhancement" target="blank">http://en.wikipedia.org/wiki/Progressive_Enhancement</a>
...
<strong>NO Logic in the View
</strong><a href="http://www.stringtemplate.org/" title="http://www.stringtemplate.org/">http://www.stringtemplate.org/</a>
